package com.ankur.interview.princeton.stdlib;
...
KeyListener, ActionListener, ChangeListener, ComponentListener, WindowFocusListener
{
    ...
    private static JMenuBar createMenuBar () {
        ...
        fovPanel.add(Box.createRigidArea(new Dimension(30, 5)));
        fovPanel.add(fovLabel);
        fovPanel.add(Box.createRigidArea(new Dimension(10, 5)));
        ...
        numDivPanel.add(Box.createRigidArea(new Dimension(5, 5)));
        numDivPanel.add(numDivLabel);
        numDivPanel.add(Box.createRigidArea(new Dimension(15, 5)));
