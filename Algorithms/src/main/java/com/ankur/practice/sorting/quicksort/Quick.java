package com.ankur.interview.sorting.quicksort;

import java.util.Arrays;

import com.ankur.interview.stdlib.StdIn;
 ...
 *
 * % java Quick < tiny.txt S O R T E X A M P L E A [ one string per line ]
 *
...
public class Quick {
	...
	public static void main(String[] args) {
		...
		String[] a = new String("Q U I C K S O R T E X A M P L E").split("\\s+");
		...
		String ith ="";
		for (int i = 0; i < a.length; i++) {
			 ith = ith+(String) Quick.select(a, i)+" ";
