 ...
 */
	...
	import com.ankur.interview.practice.trees.binarytrees.StringNode;
	...
	public class ArrayToAllInterpretations {
	    ...
	    public static StringNode createTree(int data, String pString, int[] arr) {
	        ...
	        StringNode root = new StringNode(dataToStr);
	    ...
	    public static void printleaf(StringNode root) {
	        if (root == null)
	            return;
	    ...
	    static void printAllInterpretations(int[] arr) {
	        ...
	        // Step 1: Create Tree
	        StringNode root = createTree(0, "", arr);
