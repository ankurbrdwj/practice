...
public class TestBinarySearch {
    ...
    public void TestCase1() {
        // TODO Assertions.assertTrue(BinarySearch.search(new int[]{1, 5, 23, 111}, 111) == 3);
    }
    ...
    public void TestCase3() {
       // TODO  Assertions.assertTrue(BinarySearch.search(new int[]{1, 5, 23, 111}, 35) == -1);
    }

    @Test
    public void TestCase4() {
       // TODO  Assertions.assertTrue( BinarySearch.search(new int[]{0, 1, 21, 33, 45, 45, 61, 71, 72, 73}, 33) == 3);
    }
